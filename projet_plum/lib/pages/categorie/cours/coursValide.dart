...
class CoursValide extends ConsumerStatefulWidget {
  final String id;
  const CoursValide({Key? key, required this.id}) : super(key: key);

  @override
  CoursValideState createState() => CoursValideState();
}

class CoursValideState extends ConsumerState<CoursValide> {
  /*Timer? timer;
  @override
  void initState() {
    ad();
      ...
      body: Consumer(builder: (context, ref, _) {
        ...
        return Container(
          child: ListView.builder(
            itemCount: viewModele.listcoursvalide.length,
                  ...
                  children: [
                      ...
                      children: [
                          ...
                          child: Padding(
                            ...
                            child: ClipRRect(
                              ...
                              child: Container(
                                ...
                                color: Colors.red,
                                child: Image.network(
                                  'http://13.39.81.126:7002${viewModele.listcoursvalide[index].image}',
                                  fit: BoxFit.fill,
                                ),
                              ),
                            ),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                viewModele.listcoursvalide[index].title!,
                              ...
                              Text(
                                'Créateur : Mr ${viewModele.listcoursvalide[index].creator!.lastName} ${viewModele.listcoursvalide[index].creator!.firstName}',
                                style: const TextStyle(
                                    color: Colors.white,
                                    fontSize: 20,
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Tooltip(
                            message: 'Invalider le cours',
                            child: IconButton(
                              onPressed: () {
                                valide_invalide(context,
                                    viewModele.listcoursvalide[index].sId!);
                              },
                              icon: const Icon(
                                Icons.close,
                                color: Colors.white,
                          ...
                          IconButton(
                            onPressed: () {
                              modification(
                                viewModele.listcoursvalide[index].sId,
                                viewModele.listcoursvalide[index].title,
                                viewModele.listcoursvalide[index].description,
                                viewModele.listcoursvalide[index].image,
                              );
                            },
                            icon: Icon(
                              Icons.edit,
