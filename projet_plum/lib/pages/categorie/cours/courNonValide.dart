...
class CoursNonValide extends ConsumerStatefulWidget {
  final String id;
  const CoursNonValide({Key? key, required this.id}) : super(key: key);

  @override
  CoursNonValideState createState() => CoursNonValideState();
}

class CoursNonValideState extends ConsumerState<CoursNonValide> {
  /*Timer? timer;
  @override
  void initState() {
    ad();
          ...
          Consumer(builder: (context, ref, _) {
            ...
            return Container(
              ...
              child: ListView.builder(
                itemCount: viewModele.listcoursNonvalide.length,
                      ...
                      children: [
                          ...
                          children: [
                              ...
                              child: Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Container(
                                    ...
                                    color: Colors.red,
                                    child: Image.network(
                                      'http://13.39.81.126:7002${viewModele.listcoursNonvalide[index].image}',
                                      fit: BoxFit.fill,
                                    ),
                                  ),
                                ),
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    viewModele.listcoursNonvalide[index].title!,
                                  ...
                                  Text(
                                    'Créateur : Mr ${viewModele.listcoursNonvalide[index].creator!.lastName} ${viewModele.listcoursNonvalide[index].creator!.firstName}',
                                    style: const TextStyle(
                                        color: Colors.white,
                                        fontSize: 20,
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Tooltip(
                                message: 'Valider le cours',
                                child: IconButton(
                                  onPressed: () {
                                    valide_invalide(
                                        context,
                                        viewModele
                                            .listcoursNonvalide[index].sId!);
                                  },
                                  icon: const Icon(
                                    Icons.done,
                                    color: Colors.white,
                              ...
                              IconButton(
                                onPressed: () {
                                  modification(
                                    viewModele.listcoursNonvalide[index].sId,
                                    viewModele.listcoursNonvalide[index].title,
                                    viewModele
                                        .listcoursNonvalide[index].description,
                                    viewModele.listcoursNonvalide[index].image,
                                  );
                                },
                                icon: Icon(
                                  Icons.edit,
                              ...
                              IconButton(
                                onPressed: () {
                                  dialogDelete(
                                      viewModele.listcoursNonvalide[index].sId!,
                                      viewModele
                                          .listcoursNonvalide[index].title);
                                },
                                icon: Icon(
                                  Icons.delete,
                                  color: Colors.white,
  ...
  Future<http.Response> valide_invalide(contextt, String id) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        ref.refresh(getDataCourssFuture);
        ref.refresh(getDataCoursAllFuture);
