...
import 'package:projet_plum/pages/Teacher/categorie/coursTeacher/coursTeacherMenu.dart';
...
class CategorieTeacher extends ConsumerStatefulWidget {
  const CategorieTeacher({Key? key}) : super(key: key);

  @override
  CategorieTeacherState createState() => CategorieTeacherState();
}

class CategorieTeacherState extends ConsumerState<CategorieTeacher> {
  @override
  void initState() {
    server();
                            ...
                            IconButton(
                              onPressed: () async {
                                ...
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => MenuCoursTeacher(
