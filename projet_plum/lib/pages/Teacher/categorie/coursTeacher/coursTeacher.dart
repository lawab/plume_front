...
class CoursNonValideTeacher extends ConsumerStatefulWidget {
  final String id;
  const CoursNonValideTeacher({Key? key, required this.id}) : super(key: key);

  @override
  CoursNonValideTeacherState createState() => CoursNonValideTeacherState();
}

class CoursNonValideTeacherState extends ConsumerState<CoursNonValideTeacher> {
            ...
            Consumer(builder: (context, ref, _) {
              ...
              return Container(
                ...
                child: ListView.builder(
                  itemCount: viewModele.listcoursNonvalideTeacher.length,
                                ...
                                child: Padding(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Container(
                                      ...
                                      color: Colors.red,
                                      child: Image.network(
                                        'http://13.39.81.126:7002${viewModele.listcoursNonvalideTeacher[index].image}',
                                        fit: BoxFit.fill,
                                      ),
                                    ),
                                  ),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      viewModele
                                          .listcoursNonvalideTeacher[index]
                                          .title!,
                              ...
                              children: [
                                ...
                                IconButton(
                                  onPressed: () {
                                    modification(
                                      viewModele
                                          .listcoursNonvalideTeacher[index].sId,
                                      viewModele
                                          .listcoursNonvalideTeacher[index]
                                          .title,
                                      viewModele
