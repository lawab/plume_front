...
class DevoirTeacher extends ConsumerStatefulWidget {
  const DevoirTeacher({
    Key? key,
  }) : super(key: key);

  @override
  ConsumerState<DevoirTeacher> createState() => DevoirTeacherState();
}

class DevoirTeacherState extends ConsumerState<DevoirTeacher> {
