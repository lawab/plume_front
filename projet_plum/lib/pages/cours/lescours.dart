...
class Cours extends ConsumerStatefulWidget {
  const Cours({
    Key? key,
  }) : super(key: key);

  @override
  ConsumerState<Cours> createState() => CoursState();
}

class CoursState extends ConsumerState<Cours> {
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        ...
                                                        Container(
                                                            ...
                                                            child: Tooltip(
                                                                message:
                                                                    'Voir les cours de la catégorie ${listCours[index].title!}',
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    SharedPreferences
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        ...
                                                        Container(
                                                            ...
                                                            child: Tooltip(
                                                                message:
                                                                    'Voir les cours de la catégorie ${CoursSearch[index].title!}',
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    SharedPreferences
