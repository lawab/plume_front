...
class Devoir extends ConsumerStatefulWidget {
  const Devoir({
    Key? key,
  }) : super(key: key);

  @override
  ConsumerState<Devoir> createState() => DevoirState();
}

class DevoirState extends ConsumerState<Devoir> {
