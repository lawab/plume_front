...
import 'package:projet_plum/pages/categorie/module/document/pages/read_only_page.dart';
import 'package:projet_plum/pages/categorie/module/document/universal_ui/universal_ui.dart';
...
class DocumentDevoir extends ConsumerStatefulWidget {
  const DocumentDevoir({super.key});

  @override
  DocumentDevoirState createState() => DocumentDevoirState();
}

class DocumentDevoirState extends ConsumerState<DocumentDevoir> {
