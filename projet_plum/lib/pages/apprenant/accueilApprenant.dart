...
class AccueilApprenant extends StatefulWidget {
  const AccueilApprenant({
    Key? key,
  }) : super(key: key);

  @override
  State<AccueilApprenant> createState() => AccueilApprenantState();
}

class AccueilApprenantState extends State<AccueilApprenant> {
  ...
  List historique = ["Mes cours", "Devoir de maison", "Planning"];
